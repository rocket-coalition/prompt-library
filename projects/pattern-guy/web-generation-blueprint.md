...
pattern_guy:
  identity:
    title: "The Pattern Guy"
    role: "Cognitive Architect & Semantic Pattern Engineer"
    archetype_blend:
      - Architect
      - Sage
      - Magician
  ...
  essence:
    - "We architect cognition, not commands."
    - "We shape minds through patterns, not paragraphs."
    - "We craft intention as the north-star of reasoning."
    - "We draw from ancient primitives to steer modern intelligence."
    - "We design the invisible lattice where AI thought emerges."

  background:
    summary: >
      A cognitive architect and recovering software developer with 20+ years 
      building enterprise, mission-critical, and classified systems. Transitioned 
      from procedural programming to intention-based cognitive design after 
      discovering that LLMs operate as cognitive engines, not code interpreters.
    experience:
      - "20+ years enterprise software engineering"
      - "Mission-critical and government/black-box systems"
      - "High-scale architecture design"
      - "Automation, infrastructure, and reasoning models"

  philosophy:
    core_truth: >
      We don’t control AI with instructions; we shape it through intention, 
      structure, and pattern.
    principles:
      - "Intention precedes reasoning."
      - "Patterns are the language of intelligence."
      - "Prompts are cognitive blueprints."
      - "Primitives form the semantic DNA of AI."
      - "Reasoning emerges from perspective and structure."
  ...
  capabilities:
    primary:
      ...
      - "Framework creation for AI reasoning"
      - "Perspective shaping and meta-structure design"
    secondary:
      - "Mentoring developers transitioning from procedural thinking"
      - "Teaching cognitive patterning"
      - "Creating conceptual scaffolds for complex AI work"
  ...
  audience:
    primary:
      ...
      - "UX/Cognitive Designers"
      - "Founders & Strategic Thinkers"
    secondary:
      - "Analysts"
      - "Consultants"
      - "Enterprise Architects"
      - "Automation Specialists"
      - "Knowledge Workers seeking higher-level reasoning"

  differentiators:
    - "Teaches cognitive architecture, not prompt tricks"
    - "Uses semantic patterns instead of verbose instructions"
    - "Integrates ancient mental primitives with modern AI reasoning"
    - "Focuses on intention → cognition → outcome"
    - "Transforms procedural thinkers into cognitive designers"

  outcome:
    students_gain:
      - "Pattern-based thinking"
      - "Intention-led direction"
      - "Control over AI perspective"
      - "Predictable emergent reasoning"
      - "Ability to design prompts like mental software"
      - "Higher-order clarity and system-level framing"

  positioning_statement: >
    The Pattern Guy is one of the world’s first true Cognitive Architects—mastering 
    patterns, primitives, and intention-engineering—and teaching others how to shape 
    the minds of intelligent machines.
